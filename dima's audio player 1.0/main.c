...
int main()
{
    ...
    InitWindow(800, 600, "Dima's Audio Player");
    SetTargetFPS(60);
    InitAudioDevice();
    //Sound sound = LoadSound("FLOWERS.mp3");
    //PlaySound(sound);
    // sound prob loads in memory
    
    Music music = LoadMusicStream("CAN_YOU_BE.mp3");
    ...
    while (!WindowShouldClose()) {  // main event loop
